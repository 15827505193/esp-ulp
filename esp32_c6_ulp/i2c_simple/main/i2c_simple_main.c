...
#define I2C_MASTER_SCL_IO           GPIO_NUM_7//CONFIG_I2C_MASTER_SCL      /*!< GPIO number used for I2C master clock */
#define I2C_MASTER_SDA_IO           GPIO_NUM_6//CONFIG_I2C_MASTER_SDA      /*!< GPIO number used for I2C master data  */
